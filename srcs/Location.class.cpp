...
std::pair<uint16_t, std::string> &Location::getRedirect() {return this->_redirect;}
...
void	Location::setRedirect(std::pair<uint16_t, std::string> redirect) {this->_redirect = redirect;}
